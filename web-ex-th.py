...
def finder1():
    ...
    high_price_laptop = df.loc[df['نام'].idxmax()]
    low_price_laptop = df.loc[df['نام'].idxmin()]

    print("\nگران‌ترین لپتاپ: ", high_price_laptop['نام'])
    print("ارزان‌ترین لپتاپ: ", low_price_laptop['نام'])
...
t1 = threading.Thread(target=finder1)
t2 = threading.Thread(target=finder2)
